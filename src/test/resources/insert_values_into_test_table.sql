...
VALUES ('Админус', 'Великолепный', 'admin', 'admin@mail.com', CURRENT_TIMESTAMP(0), 'ADMIN', TRUE),
       ('Анна', 'Бриг', 'anna', 'anna@mail.com', CURRENT_TIMESTAMP(0), 'TRADER', TRUE),
       ('Алексей', 'Грыж', 'alex', 'alex@mail.com', CURRENT_TIMESTAMP(0), 'TRADER', TRUE);
