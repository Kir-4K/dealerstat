...
import com.leverx.kostusev.dealerstat.service.UsrDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_USER_PAGES = {"/post/**", "/games/**"};
    private static final String[] COOKIES = {"JSESSIONID"};

    private final UsrDetailsService detailsService;
